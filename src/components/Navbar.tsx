        ...
        <>
            <motion.header
                className={cn(
                    ...
                    isScrolled
                        ? "bg-white/80 backdrop-blur-xl shadow-sm border-b border-white/20 py-2"
                        : "bg-transparent py-4"
                )}
                initial={{ y: -100 }}
                animate={{ y: 0 }}
            ...
            >
                <div className="max-w-7xl mx-auto px-4 h-[70px] flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <Button variant="ghost" size="sm" className="rounded-full hover:bg-gray-100/50 gap-2 px-3 h-10" aria-label="Change language">
